...
var Father = function (_React$Component2) {
  ...
  function Father() {
    ...
    var _this3 = _possibleConstructorReturn(this, (Father.__proto__ || Object.getPrototypeOf(Father)).call(this));
  ...
  _createClass(Father, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        '\u6211\u662F\u7236\u7EC4\u4EF6',
        this.state.name,
        _react2.default.createElement(Son, { changeName: this.changeName })
      );
    }
  }, {
    key: 'changeName',
...
_reactDom2.default.render(_react2.default.createElement(Father, null), document.querySelector('#box'));
